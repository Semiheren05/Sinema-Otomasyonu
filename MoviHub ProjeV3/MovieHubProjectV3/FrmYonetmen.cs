...
namespace MovieHubProjectV3
{
    public partial class FrmYonetmen : Form
    {
        ...
        void listeGetir()
        {
            string sorgu = "SELECT * FROM YonetmenlerTbl ORDER BY ID DESC";
        ...
        private void btnKaydet_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string sorgu = "INSERT INTO YonetmenlerTbl (AdSoyad, Cinsiyet, Yas, Biyografi, Fotograf) VALUES (@p1, @p2, @p3, @p4, @p5)";
                ...
                MessageBox.Show("Yönetmen Başarıyla Eklendi!", "İşlem Tamam", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btnSil_Click(object sender, EventArgs e)
        {
            ...
            if (karar == DialogResult.Yes)
            {
                try
                {
                    ...
                    string sorgu = "DELETE FROM YonetmenlerTbl WHERE ID = @p1";
                    SqlCommand komut = new SqlCommand(sorgu, bgl.baglanti());

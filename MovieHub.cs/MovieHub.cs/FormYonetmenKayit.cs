...
namespace MovieHub.cs
{
    public partial class FormYonetmenKayit : Form
    {
        ...
        private void buttonyonetmenkayıt_Click(object sender, EventArgs e)
        {
            if (textad.Text != "" && textsoyad.Text != "" && maskeddogum.Text != "" && photo != "")
            {
                ...
                baglanti.Open();
                SqlCommand kayit = new SqlCommand("insert into YonetmenlerTbl (AdSoyad,cinsiyet,yas,biyografi,fotograf)" +
        ...
        //private void maskeddogum_MaskInputRejected(object sender, MaskInputRejectedEventArgs e)
        //{

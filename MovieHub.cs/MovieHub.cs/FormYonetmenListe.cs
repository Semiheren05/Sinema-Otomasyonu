...
namespace MovieHub.cs
{
    public partial class FormYonetmenListe : Form
    {
        ...
        private void FormYonetmenListe_Load(object sender, EventArgs e)
        {
        ...
        private void textBoxsearch_TextChanged(object sender, EventArgs e)
        {
            listepaneli.Controls.Clear();
            baglanti.Open();
            SqlCommand ara = new SqlCommand("select * from YonetmenlerTbl where AdSoyad like '%" + textBoxsearch.Text + "%'", baglanti);
